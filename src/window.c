...
static void initialise_ui(void) {
  ...
  // s_textlayer_stock1
  s_textlayer_stock1 = text_layer_create(GRect(2, 40, 142, 24));
  ...
  // s_textlayer_stock2
  s_textlayer_stock2 = text_layer_create(GRect(2, 64, 142, 24));
  ...
  // s_textlayer_stock3
  s_textlayer_stock3 = text_layer_create(GRect(2, 88, 142, 24));
